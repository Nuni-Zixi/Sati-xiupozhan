...
disabled={isSubmitting}
  ...
  ${enhance ? "bg-transparent border-3 border-black text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-pink-400" : "bg-transparent border-3 border-black text-black"}`}
